                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="date" class="form-control" id="Tanggal_Update" name="Tanggal_Update" value="<?=$data_employee->Tanggal_Update;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="AKREDITASI" name="AKREDITASI" value="<?=$data_employee->AKREDITASI;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="LEMBUR" name="LEMBUR" value="<?=$data_employee->LEMBUR;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="TERLAMBAT" name="TERLAMBAT" value="<?=$data_employee->TERLAMBAT;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="BONUS" name="BONUS" value="<?=$data_employee->BONUS;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="GAJI" name="GAJI" value="<?=$data_employee->GAJI;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KOMPE_ID" name="KOMPE_ID" value="<?=$data_employee->KOMPE_ID; ?>">
                                        <input type="text" class="form-control" id="TOTAL_GAJI" name="TOTAL_GAJI" value="<?=$data_employee->TOTAL_GAJI;?>">
                                        <small class="text-danger">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 offset pt-4 d-flex justify-content-center">
                                            <button type="submit" class="btn btn-primary mr-1 ml-1">Update</button>
