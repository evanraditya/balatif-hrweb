        ...
        <div class="container-fluid">
            <div class="container col-md-11 pt-2">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb ">
                        <li class="breadcrumb-item"><a>Data Jabatan Karyawan</a></li>
                    </ol>
                </nav>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row pt-3">
                            <label for="Jabatan" class="col-sm-6 col-form-label">Tambah Data Jabatan</label>
                            <div class="col-sm-10">
                                            ...
                                            <?php foreach ($data_employee as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="row justify-content-center">
                                                        <a href="javascript:void(0);" data="<?= $row->JabatanId ?>" class="btn btn-danger btn-sm item-delete ml-1 mr-1"><i class="fa fa-trash"></i> </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
