                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <!-- Login form-->
                                        <h3 class="text-center">Anda sudah tercatat resign dari perusahaan! Jika terjadi kesalahan dapat menghubungi staf HR untuk merubah status anda.</h3>
                                            <div class="form-group d-flex align-items-center justify-content-center pt-2 " >                                
                                                <a class=" nav-link btn btn-danger" type="submit" href="<?php echo base_url('auth/logout'); ?>"> Kembali </a>
                                            </div>
                                    </div>
                                </div>
                            </div>
