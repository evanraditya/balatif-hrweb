                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="col-sm-12 offset pt-3 d-flex justify-content-center">
                                <a href="<?= site_url('superuser/edit/').$data_employee->KaryawanId?>" class="btn btn-success btn-sm ml-1 mr-1" data-toggle="tooltip" data-placement="bottom" title="Edit Profile"><i class="fa fa-edit"></i></a>
                                <a href="<?= site_url('superuser/add_cuti/').$data_employee->KaryawanId?>" class="btn btn-warning btn-sm ml-1 mr-1" data-toggle="tooltip" data-placement="bottom" title="Pengajuan ketidakhadiran"><i class="fa fa-book"></i></a>
                            </div>
                            </div>
                        </div>
                        </div>
...
<script>
    //menampilkan title icon saat dihover
    $(function () {
