                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" id="StatusKaryawan" name="StatusKaryawan">
                                            <?php foreach($StatusKaryawan as $row) : ?>
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" id="Departemen" name="Departemen">
                                            <?php foreach($Departemen as $row) : ?>
                                                <option value="<?= $row->Departemen?>"<?php if($row->Departemen==$data_employee->Departemen):echo"selected";endif;?>><?= $row->Departemen?></option>
                                            <?php endforeach;  ?>
                                        </select>
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    <label for="Plan" class="col-sm-3 col-form-label">Kategori</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" id="Plan" name="Plan">
                                            <?php foreach($Plan as $row) : ?>
                                                <option value="<?= $row->Plan?>"<?php if($row->Plan==$data_employee->Plan):echo"selected";endif;?>><?= $row->Plan?></option>
                                            <?php endforeach;  ?>
                                        </select>
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    <label for="Kategori" class="col-sm-3 col-form-label">Kategori Karyawan</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" id="Kategori" name="Kategori">
                                            <?php foreach($Kategori as $row) : ?>
                                                <option value="<?= $row->Kategori?>"<?php if($row->Kategori==$data_employee->Kategori):echo"selected";endif;?>><?= $row->Kategori?></option>
                                            <?php endforeach;  ?>
                                        </select>
                                        <small class="text-danger">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" id="Jabatan" name="Jabatan">
                                            <?php foreach($Jabatan as $row) : ?>
                                                <option value="<?= $row->Jabatan?>"<?php if($row->Jabatan==$data_employee->Jabatan):echo"selected";endif;?>><?= $row->Jabatan?></option>
                                            <?php endforeach;  ?>
                                        </select>
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    <label for="TanggalMasuk" class="col-sm-6 col-form-label">Tanggal Masuk Kerja</label>
                                    <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KaryawanId" name="KaryawanId" value="<?=$data_employee->KaryawanId; ?>">
                                        <input type="date" class="form-control" id="TanggalMasuk" name="TanggalMasuk" value="<?=$data_employee->TanggalMasuk; ?>">
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    <label for="HakAkses" class="col-sm-3 col-form-label">Gender</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" id="HakAkses" name="HakAkses">
                                            <?php foreach($Hakakses as $row) : ?>
                                                <option value="<?= $row->HakAkses?>"<?php if($row->HakAkses==$data_employee->HakAkses):echo"selected";endif;?>><?= $row->HakAkses?></option>
                                            <?php endforeach;  ?>
                                        </select>
                                        <small class="text-danger">
                                            <?php echo form_error('HakAkses') ?>
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="hidden" class="form-control" id="KaryawanId" name="KaryawanId" value="<?=$data_employee->KaryawanId; ?>">
                                        <input type="text" class="form-control" id="PASSWORD" name="PASSWORD" value="<?=$data_employee->PASSWORD; ?>">
                                        <small class="text-danger">
