                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="hidden" class="form-control" id="CutiId" name="CutiId" value="<?= $data_cuti->CutiId; ?>">
                                    <input readonly class="form-control-plaintext" class="form-control" id="Tanggal" name="Tanggal" value="<?= $data_cuti->Tanggal; ?>">
                                    <small class="text-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="hidden" class="form-control" id="CutiId" name="CutiId" value="<?= $data_cuti->CutiId; ?>">
                                    <input readonly class="form-control-plaintext" class="form-control" id="CutiAwal" name="CutiAwal" value="<?= $data_cuti->CutiAwal; ?>">
                                    <small class="text-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="hidden" class="form-control" id="CutiId" name="CutiId" value="<?= $data_cuti->CutiId; ?>">
                                    <input readonly class="form-control-plaintext" class="form-control" id="CutiAkhir" name="CutiAkhir" value="<?= $data_cuti->CutiAkhir; ?>">
                                    <small class="text-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" id="StatusCuti" name="StatusCuti">
                                        ...
                                        <option value="Diterima" <?php if ($data_cuti->StatusCuti == "Diterima") : echo "selected";
                                                                    endif; ?>>Diterima</option>
                                        <option value="Ditolak" <?php if ($data_cuti->StatusCuti == "Ditolak") : echo "selected";
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control" id="Penolakan" name="Penolakan" rows="3"><?= $data_cuti->Penolakan; ?></textarea>
                                    <small class="text-danger">
